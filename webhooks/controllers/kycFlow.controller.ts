...
import { getKycFlowScreen } from "../services/kycFlow.service";
import { flowMiddleware } from "../middlewares";

export const kycFlow = flowMiddleware(async (req: Request, res: Response) => {
  ...
  const screenResponse = await getKycFlowScreen(decryptedBody);
