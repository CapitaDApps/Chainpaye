...
import { getConversionFlowScreen } from "../services/conversion.service";

export const conversionFlow = flowMiddleware(
  async (req: Request, res: Response) => {
    ...
    */
    ...
    const screenResponse = await getConversionFlowScreen(decryptedBody);
